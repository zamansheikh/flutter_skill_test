          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                GellaryImages(widget: widget),
                //Location
                SizedBox(height: 20),
                //show map on a container
                MapMarker(widget: widget),
              ],
            ),
          ),
        ),
...
class GellaryImages extends StatelessWidget {
  const GellaryImages({
    super.key,
    required this.widget,
  });
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        GestureDetector(
          onTap: () async {
            await dialNumber(widget.house.ownerPhone);
          },
          child: Container(
            height: 30,
            width: 30,
        ...
        GestureDetector(
          onTap: () async {
            await messageNumber(widget.house.ownerPhone,
